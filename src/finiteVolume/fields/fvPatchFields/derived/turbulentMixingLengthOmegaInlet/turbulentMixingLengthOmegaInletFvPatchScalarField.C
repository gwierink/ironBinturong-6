    ...
    kName_(dict.lookupOrDefault<word>("k", "k"))
{
    ...
    if (mixingLength_ < 0)
    {
        FatalErrorInFunction
            << "Turbulence mixing length should be specified as larger than 0\n"
               "    value given is " << mixingLength_ << nl
...
void Foam::turbulentMixingLengthOmegaInletFvPatchScalarField::
updateCoeffs()
{
    if (updated())
    {
...
void Foam::turbulentMixingLengthOmegaInletFvPatchScalarField::write
(
    Ostream& os
) const
{
